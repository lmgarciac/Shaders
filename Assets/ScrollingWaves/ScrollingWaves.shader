Shader "ScrollingWaves/Waves"
{
    ...
    SubShader
    {
       ...
       void vert (inout appdata v, out Input o)
       {
            ...
            //Regular sin wave form
            //float waveHeight = sin(t + v.vertex.x * _Freq) * _Amp;
            
            //Playing around with an additional sine wave
            float waveHeight = sin(t + v.vertex.x * _Freq) * _Amp + sin(t*2 + v.vertex.x * _Freq*2 + 20) * _Amp;
