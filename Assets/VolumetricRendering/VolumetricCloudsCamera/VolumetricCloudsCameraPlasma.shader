Shader "Holistic/VolumetricCloudsCameraPlasma"
{
    Properties
    {
        _MainTex ("", 2D) = "white" {}  
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            fixed4 integrate (fixed4 sum, float diffuse, float density, fixed4 bgcol, float t)
            {
                ...
                //col.rgb = lerp(col.rgb, plasma, exp(-0.003*t*t)); //Use this instead if you want the plasma to be on top
                col.rgb = lerp(col.rgb, plasma, 1.0 - exp(-0.003*t*t)); //Use this instead if you want the plasma to be on the back
                //col.rgb = lerp(col.rgb, plasma, sum.a); //Use this for another cool effect where the plasma is extended to the end of the view
                //col.rgb = lerp(col.rgb, plasma, 1.0 - exp(5*t*t)); //Use this for a cool psychodelic effect
